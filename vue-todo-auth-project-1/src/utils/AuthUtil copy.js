...
// ==============================
const routesToRoles = [
  { name: 'login', roles: ['everybody'] },
  { name: 'notfound', roles: ['everybody'] },
  { name: 'home', roles: ['users'] },
  { name: 'about', roles: ['users'] },
  { name: 'mypage', roles: ['users'] },
  { name: 'todos', roles: ['users'] },
  { name: 'todos/add', roles: ['users' ]},
  { name: 'todos/edit', roles: ['users' ] },
]
